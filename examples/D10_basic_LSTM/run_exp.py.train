...
def main(main_args):
	...
	## Simulator
	simulator_args = {}
	simulator_args['config'] = '../../maps/D1_basic.cfg' # defines some parameter (available buttons, game variables etc)
	...
	# agent type
	agent_args['agent_type'] = 'lstm' # Defines the kind of network used for the prediction
