...
def main(main_args):
	...
	targ_scale_coeffs = np.expand_dims((np.expand_dims(np.array([30.,100000000.,100000000.]),1) * np.ones((1,len(target_maker_args['future_steps'])))).flatten(),0) # addapt dim to meas?
